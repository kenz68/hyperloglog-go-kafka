...
// UserMsg Message types and helper methods
type UserMsg struct {
	Uid string `json:"uid"`
	Ts  uint64 `json:"ts"`
}
...
// Takes the timestamp and return the number seconds to the next
...
// ProcessMessages Processing messages from input channel and routing them to the output channel
